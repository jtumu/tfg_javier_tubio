...
carpeta_resultados <- "Figuras_TFG_EColi"
...
write.csv(
  ...
  file = file.path(carpeta_resultados, "Comparativa_Aciertos_EColi.csv"),
  row.names = FALSE
)
...
conteo_control <- Orgs_Control %>%
 ...
 write.csv(
   x = conteo_control, 
   file = file.path(carpeta_resultados, "Organismos_donadores_EColi_Control.csv"),
   row.names = FALSE
 )
# Randoms 
...
write.csv(
  ...
  file = file.path(carpeta_resultados, "Organismos_donadores_EColi_Random.csv"),
  row.names = FALSE
)
...
write.csv(
  ...
  file = file.path(carpeta_resultados, "Wang_EColi_Randoms.csv"),
  row.names = FALSE
)
...
write.csv(
  ...
  file = file.path(carpeta_resultados, "Wang_EColi_Control.csv"),
  row.names = FALSE
)
...
ggsave(
  filename = file.path(carpeta_resultados, "Enriquecimiento_GO_Randoms_EColi.png"), 
...
ggsave(
  filename = file.path(carpeta_resultados, "Enriquecimiento_GO_Control_EColi.png"), 
...
write.csv(
  x = tabla_ic_completa, 
  file = file.path(carpeta_resultados, "IC_EColi.csv"),
  row.names = FALSE
)
...
grafico_mf_real<-grafico_real_ontologia(ic_real_mf, "MF")
ggsave(
  filename = file.path(carpeta_resultados, "Top10GO_MF_Real_EColi.png"), 
  plot = grafico_mf_real, 
  width = 12,                    
  height = 8,                    
  dpi = 300,                    
  bg = "white"                    
...
grafico_bp_real<-grafico_real_ontologia(ic_real_bp, "BP")
ggsave(
  filename = file.path(carpeta_resultados, "Top10GO_BP_Real_EColi.png"), 
  plot = grafico_bp_real, 
  width = 12,                    
  height = 8,                    
  dpi = 300,                    
  bg = "white"                    
)
grafico_cc_real<-grafico_real_ontologia(ic_real_cc, "CC")
ggsave(
  filename = file.path(carpeta_resultados, "Top10GO_CC_Real_EColi.png"), 
  plot = grafico_cc_real, 
  width = 12,                    
  height = 8,                    
  dpi = 300,                    
  bg = "white"                    
...
grafico_control_ontologia <- function(datos_ontologia_control, ontologia){
  ...
  return(grafico_control_ordenado)
}
grafico_mf_control <- grafico_control_ontologia(ic_pred_mf_control, "MF")
ggsave(
  filename = file.path(carpeta_resultados, "Top10GO_MF_Control_EColi.png"), 
  plot = grafico_mf_control, 
  width = 12,                    
  height = 8,                    
  dpi = 300,                    
  bg = "white"                    
...
grafico_bp_control <- grafico_control_ontologia(ic_pred_bp_control, "BP")
ggsave(
  filename = file.path(carpeta_resultados, "Top10GO_BP_Control_EColi.png"), 
  plot = grafico_bp_control, 
  width = 12,                    
  height = 8,                    
  dpi = 300,                    
  bg = "white"                    
...
grafico_cc_control <- grafico_control_ontologia(ic_pred_cc_control, "CC")
ggsave(
  filename = file.path(carpeta_resultados, "Top10GO_CC_Control_EColi.png"), 
  plot = grafico_cc_control, 
  width = 12,                    
  height = 8,                    
  dpi = 300,                    
  bg = "white"                    
...
grafico_random_ontologia <- function (datos_ontologia_random, ontologia) {
  ...
  return(grafico_randomizados_ordenado)
}
grafico_mf_random<-grafico_random_ontologia(ic_pred_mf, "MF")
ggsave(
  filename = file.path(carpeta_resultados, "Top10GO_MF_Random_EColi.png"), 
  plot = grafico_mf_random, 
  width = 12,                    
  height = 8,                    
  dpi = 300,                    
  bg = "white"                    
...
grafico_bp_random<-grafico_random_ontologia(ic_pred_bp, "BP")
ggsave(
  filename = file.path(carpeta_resultados, "Top10GO_BP_Random_EColi.png"), 
  plot = grafico_bp_random, 
  width = 12,                    
  height = 8,                    
  dpi = 300,                    
  bg = "white"                    
)
grafico_cc_random<-grafico_random_ontologia(ic_pred_cc, "CC")
ggsave(
  filename = file.path(carpeta_resultados, "Top10GO_CC_Random_EColi.png"), 
  plot = grafico_cc_random, 
  width = 12,                    
  height = 8,                    
  dpi = 300,                    
  bg = "white"                    
